...
export default function RegisterPage({ onEmailRegister, onGoogleRegister, authError, authSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (onEmailRegister) {
        await onEmailRegister(form.firstName.trim(), form.lastName.trim(), form.username.trim(), form.email.trim(), form.password);
        // Clear form fields on a completely clean registration setup
