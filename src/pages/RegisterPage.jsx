      ...
      <svg className="w-3.5 h-3.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd"
          d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 
             1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
          clipRule="evenodd"
        />
      </svg>
      {message}
...
//   authError            → string | null   (Supabase error)
//   authSuccess          → string | null   (e.g. "Check your email to confirm.")
...
export default function RegisterPage({
  ...
  function inputStyle(hasError) {
    return {
      base: `w-full rounded-lg border px-4 py-3 text-sm text-gray-900 bg-white
             shadow-sm placeholder-gray-400 outline-none transition-all duration-200
             disabled:bg-gray-100 disabled:cursor-not-allowed`,
      border: hasError ? "border-red-400" : "border-gray-300",
    };
  }
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="absolute bottom-0 -left-10 w-80 h-80 rounded-full opacity-[0.06]"
          style={{ backgroundColor: "#59ABBD" }} />
        ...
        <div className="relative z-10 space-y-6">
          <h1 className="text-5xl font-bold leading-tight text-white"
            ...
            Join the<br />HR<br />
            <span style={{ color: "#59ABBD" }}>Portal</span>
          </h1>
          <p className="text-sm leading-relaxed max-w-xs" style={{ color: "#9FB3C8" }}>
            Create your account to request access. An HR Administrator
            will activate your account before you can sign in.
          </p>
          ...
          <div className="space-y-3 pt-2">
            {[
              ...
              "Sign in to the HR portal",
            ].map((text, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full flex items-center justify-center
                                text-xs font-bold shrink-0"
                  style={{ backgroundColor: "#59ABBD22", color: "#59ABBD",
                           border: "1px solid #59ABBD44" }}>
                  {i + 1}
                </div>
        ...
        <div className="w-full max-w-md space-y-7">
          ...
          <div className="flex items-center gap-3 lg:hidden pt-2">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center font-bold"
              style={{ backgroundColor: "#1B263B", color: "#59ABBD" }}>H</div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500">
              All fields are required. Your account will be activated by an HR Admin.
            </p>
          </div>
          ...
          {authError && (
            <div className="flex items-start gap-3 rounded-lg border border-red-200
                            bg-red-50 px-4 py-3">
              <svg className="w-4 h-4 mt-0.5 text-red-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd"
          ...
          {authSuccess && (
            <div className="flex items-start gap-3 rounded-lg border border-green-200
              ...
              <svg className="w-4 h-4 mt-0.5 text-green-600 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-lg border
                       ...
                       shadow-sm transition-all duration-200 hover:border-gray-400
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium mb-1.5"
                  style={{ color: "#1B263B" }}>First Name</label>
                <input
                  id="firstName"
                  type="text"
                  ...
                  className={`${inputStyle(errors.firstName).base} ${inputStyle(errors.firstName).border}`}
                  onFocus={(e) => focusStyle(e, errors.firstName)}
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium mb-1.5"
                  style={{ color: "#1B263B" }}>Last Name</label>
                <input
                  id="lastName"
                  type="text"
                  value={form.lastName}
                  ...
                  className={`${inputStyle(errors.lastName).base} ${inputStyle(errors.lastName).border}`}
                  onFocus={(e) => focusStyle(e, errors.lastName)}
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium mb-1.5"
                style={{ color: "#1B263B" }}>Username</label>
              <input
                id="username"
                type="text"
                value={form.username}
                onChange={handleChange("username")}
                placeholder="msantos_hr"
                disabled={isLoading}
                autoComplete="username"
                className={`${inputStyle(errors.username).base} ${inputStyle(errors.username).border}`}
                onFocus={(e) => focusStyle(e, errors.username)}
                onBlur={(e)  => blurStyle(e,  errors.username)}
              />
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium mb-1.5"
                style={{ color: "#1B263B" }}>Email Address</label>
              <input
                id="email"
                type="email"
                value={form.email}
                onChange={handleChange("email")}
                placeholder="maria@hope.com"
                disabled={isLoading}
                autoComplete="email"
                className={`${inputStyle(errors.email).base} ${inputStyle(errors.email).border}`}
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium mb-1.5"
                style={{ color: "#1B263B" }}>Password</label>
              <div className="relative">
                <input
                  ...
                  className={`${inputStyle(errors.password).base} ${inputStyle(errors.password).border} pr-11`}
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-1.5"
                style={{ color: "#1B263B" }}>Confirm Password</label>
              <div className="relative">
                <input
                  id="confirmPassword"
                  ...
                  disabled={isLoading}
                  autoComplete="new-password"
                  className={`${inputStyle(errors.confirmPassword).base} ${inputStyle(errors.confirmPassword).border} pr-11`}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-lg
                         ...
                         duration-200 shadow-sm disabled:cursor-not-allowed
          ...
          <p className="text-center text-sm text-gray-500 pb-8">
            ...
            <Link to="/login" className="font-medium hover:underline transition-colors"
              style={{ color: "#59ABBD" }}>
              Sign in here
            </Link>
          </p>
